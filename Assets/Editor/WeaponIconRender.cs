...
public static class WeaponIconRender
{
    ...
    static readonly (string weapon, string prefabField)[] Weapons =
    {
        ...
        ("WD_Drone",         "dronePrefab"),
        ("WD_PlasmaOrb",     "orbPrefab"),
        ("WD_EMPField",      "weaponPrefab"),
        ("WD_RepairNano",    "weaponPrefab"),
        ("WD_TeslaCoil",     "weaponPrefab"),
        ("WD_AcidPool",      "weaponPrefab"),
        ("WD_MissilePod",    "weaponPrefab"),
        ("WD_OrbitalStrike", "weaponPrefab"),
    };
