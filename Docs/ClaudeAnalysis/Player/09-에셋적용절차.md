...
- 텍스처, 라이선스, readme 파일이 없다. → **2026-09-14 확인: Quaternius의 [Sci-Fi Modular Gun Pack](https://quaternius.com/packs/scifimodularguns.html)(모델 78개, CC0)이다.** 개인·상업 프로젝트 모두 자유롭게 쓸 수 있고 저장소에 올려도 된다.
...
| A4 | 에셋 출처·라이선스 | — | **확인 완료 (2026-09-14)**: Quaternius Sci-Fi Modular Gun Pack, CC0. 크레딧 표기는 의무가 아니지만 권장 |
